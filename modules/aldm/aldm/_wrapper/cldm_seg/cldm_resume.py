...
class ControlLDM_modified(LatentDiffusion):
    ...
    def val_dataloader(self):
        ...
        dataset = dataset_factory(self.dataset)(mode='val', train_mode=True, augment_dict=augment_dict)
    ...
    def configure_optimizers(self):
        ...
        num_param =sum(dict((p.data_ptr(), p.numel()) for p in self.control_model.parameters()).values())
        print(f'trainable parameters: {num_param} = {num_param / 1_000_000}M')
    ...
    def sample_log(self, cond, batch_size, ddim, ddim_steps, generator=None, **kwargs):
        ...
        random_shape = (batch_size, self.channels, h // 8, w // 8)
