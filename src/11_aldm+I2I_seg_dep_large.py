...
"""
This script was used to generate the third person image2image segmentation + depth dataset, 
which is based on Synthehicle. Therefor all necessary transformations to the depth images had to be done. 
...
if __name__ == "__main__":
    ...
    sifs_config = SIFSConfig(
        output_dir="data/output_8_large/first_person/img",
    )
